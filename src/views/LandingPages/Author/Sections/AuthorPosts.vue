<script setup>
// example components
import TransparentBlogCard from "../../../../layouts/cards/blogCards/TransparentBlogCard.vue";
import BackgroundBlogCard from "../../../../layouts/cards/blogCards/BackgroundBlogCard.vue";
